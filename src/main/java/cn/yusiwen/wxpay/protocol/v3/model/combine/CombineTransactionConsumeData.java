...
import cn.yusiwen.wxpay.protocol.enumeration.TradeType;
import cn.yusiwen.wxpay.protocol.v3.model.PromotionDetail;
import cn.yusiwen.wxpay.protocol.v3.model.SceneInfo;
...
public class CombineTransactionConsumeData {
    ...
    public static class SubOrderCallback {
        ...
        /**
         * 付款银行类型，参见<a target= "_blank" href=
         * "https://pay.weixin.qq.com/wiki/doc/apiv3/terms_definition/chapter1_1_3.shtml#part-4">开户银行对照表</a>
         */
