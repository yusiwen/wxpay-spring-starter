...
import cn.yusiwen.wxpay.protocol.v3.model.profitsharing.AddReceiversParams;
import cn.yusiwen.wxpay.protocol.v3.model.profitsharing.DelReceiversParams;
import cn.yusiwen.wxpay.protocol.v3.model.profitsharing.ProfitSharingOrder;
import cn.yusiwen.wxpay.protocol.v3.model.profitsharing.QueryOrderParams;
import cn.yusiwen.wxpay.protocol.v3.model.profitsharing.QueryReturnOrderParams;
import cn.yusiwen.wxpay.protocol.v3.model.profitsharing.Receiver;
import cn.yusiwen.wxpay.protocol.v3.model.profitsharing.ReturnOrdersParams;
import cn.yusiwen.wxpay.protocol.v3.model.profitsharing.UnfreezeParams;
        ...
        this.client().withType(WechatPayV3Type.PROFITSHARING_ORDERS_RESULT, queryOrderParams)
                .function((wechatPayV3Type, params) -> {
                    ...
                    URI uri = UriComponentsBuilder.fromHttpUrl(wechatPayV3Type.uri(WeChatServer.CHINA))
                            .queryParam("transaction_id", params.getTransactionId()).build()
                            .expand(params.getOutOrderNo()).toUri();
                    return get(uri);
                }).consumer(wechatResponseEntity::convert).request();
        return wechatResponseEntity;
    }
    ...
    public WechatResponseEntity<ObjectNode> queryReturnOrders(QueryReturnOrderParams queryReturnOrderParams) {
        ...
        this.client().withType(WechatPayV3Type.PROFITSHARING_RETURN_ORDERS_RESULT, queryReturnOrderParams)
                .function((wechatPayV3Type, params) -> {
                    ...
                    URI uri = UriComponentsBuilder.fromHttpUrl(wechatPayV3Type.uri(WeChatServer.CHINA))
                            .queryParam("out_order_no", params.getOutOrderNo()).build().expand(params.getOutReturnNo())
                            .toUri();
                    return get(uri);
                }).consumer(wechatResponseEntity::convert).request();
        return wechatResponseEntity;
