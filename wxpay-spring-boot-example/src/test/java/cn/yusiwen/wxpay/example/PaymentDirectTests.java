...
import cn.yusiwen.wxpay.protocol.v3.X509WechatCertificateInfo;
import cn.yusiwen.wxpay.protocol.v3.model.Amount;
import cn.yusiwen.wxpay.protocol.v3.model.H5Info;
...
public class PaymentDirectTests {
    ...
    public void encrypt() {
        ...
        X509WechatCertificateInfo certificate = signatureProvider.getCertificate(tenantId);
