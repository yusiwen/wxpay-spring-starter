...
import cn.yusiwen.wxpay.protocol.v2.WechatAllocationApi;
import cn.yusiwen.wxpay.protocol.v2.WechatPayRedpackApi;
import cn.yusiwen.wxpay.protocol.v2.WechatPayTransfersApi;
import cn.yusiwen.wxpay.protocol.v2.WechatV2Client;
...
public class WechatApiProvider {
    ...
    public WechatPayRedpackApi redpackApi(String tenantId) {
        WechatMetaBean wechatMeta = wechatPayClient.signatureProvider().wechatMetaContainer().getWechatMeta(tenantId);
