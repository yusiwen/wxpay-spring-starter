...
import cn.yusiwen.wxpay.protocol.v3.model.payscore.CancelServiceOrderParams;
import cn.yusiwen.wxpay.protocol.v3.model.payscore.CompleteServiceOrderParams;
import cn.yusiwen.wxpay.protocol.v3.model.payscore.DirectCompleteServiceOrderParams;
import cn.yusiwen.wxpay.protocol.v3.model.payscore.ModifyServiceOrderParams;
import cn.yusiwen.wxpay.protocol.v3.model.payscore.PayServiceOrderParams;
import cn.yusiwen.wxpay.protocol.v3.model.payscore.PermissionsAuthCodeParams;
import cn.yusiwen.wxpay.protocol.v3.model.payscore.PermissionsOpenIdParams;
import cn.yusiwen.wxpay.protocol.v3.model.payscore.QueryServiceOrderParams;
import cn.yusiwen.wxpay.protocol.v3.model.payscore.ServiceOrderPermissionParams;
import cn.yusiwen.wxpay.protocol.v3.model.payscore.SyncServiceOrderParams;
import cn.yusiwen.wxpay.protocol.v3.model.payscore.UserServiceOrderParams;
import cn.yusiwen.wxpay.protocol.v3.model.payscore.UserServiceStateParams;
...
public class WechatPayScoreApi extends AbstractApi {
     ...
     * 微信支付分-查询用户授权状态API.
     * <p>
     * 免确认订单起始接口，【免确认订单模式】是高级接口权限，参见：<a href=
     * "https://pay.weixin.qq.com/wiki/doc/apiv3/wxpay/payscore/chapter2_5.shtml">业务流程说明</a>
     * <p>
    ...
    public WechatResponseEntity<ObjectNode> queryPermissionsByAuthCode(PermissionsAuthCodeParams params) {
        ...
        this.client().withType(WechatPayV3Type.PAY_SCORE_PERMISSIONS_AUTH_CODE, params)
                .function((wechatPayV3Type, orderParams) -> {
                    URI uri = UriComponentsBuilder.fromHttpUrl(wechatPayV3Type.uri(WeChatServer.CHINA))
                            .queryParam("service_id", orderParams.getServiceId()).build()
                            .expand(orderParams.getAuthorizationCode()).toUri();
