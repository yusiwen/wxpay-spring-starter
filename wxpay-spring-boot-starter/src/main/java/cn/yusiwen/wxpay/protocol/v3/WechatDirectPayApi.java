...
import cn.yusiwen.wxpay.protocol.v3.model.RefundParams;
...
public class WechatDirectPayApi extends AbstractApi {
    ...
    public WechatResponseEntity<ObjectNode> appPay(PayParams payParams) {
        ...
        this.client().withType(WechatPayV3Type.APP, payParams).function(this::payFunction).consumer(responseEntity -> {
    ...
    public WechatResponseEntity<ObjectNode> jsPay(PayParams payParams) {
        WechatResponseEntity<ObjectNode> wechatResponseEntity = new WechatResponseEntity<>();
        this.client().withType(WechatPayV3Type.JSAPI, payParams).function(this::payFunction)
                .consumer(responseEntity -> {
                    ...
                    String paySign = signatureProvider.doRequestSign(privateKey, appId, timestamp, nonceStr,
                            packageStr);
    ...
    public WechatResponseEntity<ObjectNode> nativePay(PayParams payParams) {
        WechatResponseEntity<ObjectNode> wechatResponseEntity = new WechatResponseEntity<>();
        this.client().withType(WechatPayV3Type.NATIVE, payParams).function(this::payFunction)
    ...
    public WechatResponseEntity<ObjectNode> h5Pay(PayParams payParams) {
        WechatResponseEntity<ObjectNode> wechatResponseEntity = new WechatResponseEntity<>();
        this.client().withType(WechatPayV3Type.MWEB, payParams).function(this::payFunction)
                .consumer(wechatResponseEntity::convert).request();
        return wechatResponseEntity;
    }
    ...
    public WechatResponseEntity<ObjectNode> close(String outTradeNo) {
        WechatResponseEntity<ObjectNode> wechatResponseEntity = new WechatResponseEntity<>();
        this.client().withType(WechatPayV3Type.CLOSE, outTradeNo).function(this::closeByOutTradeNoFunction)
                .consumer(wechatResponseEntity::convert).request();
        return wechatResponseEntity;
    }
    ...
    private RequestEntity<?> closeByOutTradeNoFunction(WechatPayV3Type type, String outTradeNo) {
        ...
        URI uri = UriComponentsBuilder.fromHttpUrl(type.uri(WeChatServer.CHINA)).build().expand(outTradeNo).toUri();
    ...
    public WechatResponseEntity<ObjectNode> queryRefundInfo(String outRefundNo) {
        ...
        this.client().withType(WechatPayV3Type.QUERY_REFUND, outRefundNo).function((type, param) -> {
            URI uri = UriComponentsBuilder.fromHttpUrl(type.uri(WeChatServer.CHINA)).build().expand(param).toUri();
            return get(uri);
        }).consumer(wechatResponseEntity::convert).request();
        return wechatResponseEntity;
    }
